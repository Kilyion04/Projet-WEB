...
<html lang="fr">
    <head>
        ...
        <title>CesiTonStage - Page Étudiant</title>
    </head>

    <body class="page_étudiant">
        <?php include 'sidebar.php';
        ?>
        <section class="container_0">
            <div class="container" >
                <p style="font-weight: bold">Nom_étudiant</p>
            ...
            <div class="info">
                <div class="btn-group">
                <input type="button" value="Avancement" id="btn-1" style="display: block;"></input>
    ...
    <script type="text/javascript" src="bouton-étudiant.js"></script>

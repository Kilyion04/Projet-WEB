...
<html lang="fr">
    <head>
        <meta charset="utf-8">
        <link rel="stylesheet" href="profil_délégué.css">
    ...
    <body>
        ...
        <div class="info">
            <div class="container_1">
                <h2>Informations</h2>
                <p>Vous avez créé emploies</p>
                <p>Type d'emploi créé</p>
                <p>Fichiers importés</p>
                <img src="./img/icon/pin.png" width="10" height="8">
                <p>Vos coordonnées</p>
            </div>
            <div class="btn-group">
                ...
                <input type="button" value="Contacts" id="btn-3" style="position: ;"></input>
                ...
                <div id="entreprise" class="formulaire" style="display: none">
                    <div class="créer_entreprise">
                        <form id="créer_entreprise">
                            ...
                            <input type="number" placeholder="Entrer un ID" name="nombre">
                        </form>
                    <br>
                    </div>
                    <div class="modifier_entreprise">
                        <form id="modifier_entreprise">
                            ...
                            <input type="email" placeholder="Entrer mail" name="email"> <br>
                            <label for="activité"><b>Activité</b></label> <br>
                            <input type="texte" placeholder="Activité" name="activité"> <br>
                            <label for="number"><b>ID ofentreprisefres</b></label> <br>
                            <input type="number" placeholder="Entrer un ID" name="nombre">
                        </form>
                    <br>    
                    </div>
                ...
                <div id="offre" class="formulaire" style="display: none">
                    ...
                    <div class="supprimer_offre">
                        <form id="supprimer_offre">
                            ...
                            <input type="texte" placeholder="Entrer nom" name="offre">
                        </form>
                    </div>
                </div>

                <div id="contacts" class="formulaire" style="display: none">
                    <form>
                        requete sql, select user from profil where role= 'admin' or 'pilote' or 'délégué'
                    </form>
                </div>
                ...
                <div id="promotion" class="formulaire" style="display: none">
                    <form>
                        requete sql, select promo where id = '.....'
                    </form>
                </div>
            </div>
        </div>

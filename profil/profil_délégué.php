...
<html lang="fr">
    <head>
        ...
        <title>CesiTonStage - Page Délégué</title>
    </head>

    <body class="page_délégué">
        <?php include 'sidebar.php';
        ?>
        <section class="container_0">
            <div class="container" >
                <p style="font-weight: bold">Nom_Délégué</p>
    ...
    <script type="text/javascript" src="bouton_délégué.js"></script>
